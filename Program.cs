...
namespace Sudoku.Backtracking
{
    public class Program
    {
        public static void Main(string[] args)
        {
            if (args.Length == 0)
            {
                Console.WriteLine("Veuillez spécifier le chemin vers le fichier Sudoku en argument.");
                return;
            }
            ...
            try
            {
                ...
                Console.WriteLine($"Tous les Sudokus ont été résolus. Nombre total de Sudokus résolus : {sudokuCount}");
            }
